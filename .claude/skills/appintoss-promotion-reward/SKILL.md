...
**If Game**: Read [.agent/skills/appintoss-promotion-reward/reference/game-sdk.md](.agent/skills/appintoss-promotion-reward/reference/game-sdk.md) and follow the SDK-based approach. The rest of this guide is for non-game apps.
...
```
If No → Guide through console registration. See [.agent/skills/appintoss-promotion-reward/reference/official-api.md](.agent/skills/appintoss-promotion-reward/reference/official-api.md), Console Guide section.
...
For detailed console procedures, see [.agent/skills/appintoss-promotion-reward/reference/official-api.md](.agent/skills/appintoss-promotion-reward/reference/official-api.md).
...
Write and run a temporary Node.js test script using `npx tsx`. See [.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md](.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md) for the complete cross-platform test script.
...
The proven implementation pattern from a production non-game mini-app. See [.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md](.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md) for complete code.
...
For complete client patterns, see [.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md](.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md).
...
For detailed setup steps, see [.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md](.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md).

---

## Phase 6: QA Verification

Complete QA checklist before going live. See [.agent/skills/appintoss-promotion-reward/reference/qa-checklist.md](.agent/skills/appintoss-promotion-reward/reference/qa-checklist.md) for the full official checklist.
...
- **[.agent/skills/appintoss-promotion-reward/reference/official-api.md](.agent/skills/appintoss-promotion-reward/reference/official-api.md)** — Complete Toss API specs, console guide, error codes, dashboard, FAQ, pre-launch checklist
- **[.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md](.agent/skills/appintoss-promotion-reward/reference/implementation-patterns.md)** — Production-proven code patterns (mTLS, promotion service, client hooks, DB schema)
- **[.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md](.agent/skills/appintoss-promotion-reward/reference/setup-and-testing.md)** — mTLS setup, test code activation, Supabase MCP queries, terminal scripts
- **[.agent/skills/appintoss-promotion-reward/reference/qa-checklist.md](.agent/skills/appintoss-promotion-reward/reference/qa-checklist.md)** — Official QA checklist with pass/fail criteria
- **[.agent/skills/appintoss-promotion-reward/reference/error-codes.md](.agent/skills/appintoss-promotion-reward/reference/error-codes.md)** — Complete error code reference with resolution steps
- **[.agent/skills/appintoss-promotion-reward/reference/game-sdk.md](.agent/skills/appintoss-promotion-reward/reference/game-sdk.md)** — Game app SDK approach (grantPromotionRewardForGame)
