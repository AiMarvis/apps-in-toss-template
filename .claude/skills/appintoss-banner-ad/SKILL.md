...
For full API types and signatures, see [.agent/skills/appintoss-banner-ad/references/api-reference.md](.agent/skills/appintoss-banner-ad/references/api-reference.md).
