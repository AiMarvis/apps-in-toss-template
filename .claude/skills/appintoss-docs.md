...
Violations cause immediate rejection. See [.agent/skills/appintoss-docs/references/review-rules.md](.agent/skills/appintoss-docs/references/review-rules.md) for the complete list with examples.
...
| Task | Reference |
|------|-----------|
| Need full API signatures, parameters, or event types | [.agent/skills/appintoss-docs/references/sdk-api-catalog.md](.agent/skills/appintoss-docs/references/sdk-api-catalog.md) |
| Checking review compliance or preparing for submission | [.agent/skills/appintoss-docs/references/review-rules.md](.agent/skills/appintoss-docs/references/review-rules.md) |
| Implementing hooks (auth, ads, IAP, share, banner) | [.agent/skills/appintoss-docs/references/code-examples.md](.agent/skills/appintoss-docs/references/code-examples.md) |
| Finding official doc URLs for deep reference | [.agent/skills/appintoss-docs/references/official-doc-urls.md](.agent/skills/appintoss-docs/references/official-doc-urls.md) |
