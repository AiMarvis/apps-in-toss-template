...
- **Colors**: `@toss/tds-colors` - See [colors.md](.agent/skills/appintoss-tds-mobile/references/colors.md)
- **Typography**: 7 primary levels (30px-13px) - See [typography.md](.agent/skills/appintoss-tds-mobile/references/typography.md)
- **Components**: 40+ components - See [components.md](.agent/skills/appintoss-tds-mobile/references/components.md)
...
Key prop renames (full list in [.agent/skills/appintoss-tds-mobile/references/migration-v2.md](.agent/skills/appintoss-tds-mobile/references/migration-v2.md)):
...
- **Color tokens & hex values**: [.agent/skills/appintoss-tds-mobile/references/colors.md](.agent/skills/appintoss-tds-mobile/references/colors.md)
- **Typography scale & accessibility**: [.agent/skills/appintoss-tds-mobile/references/typography.md](.agent/skills/appintoss-tds-mobile/references/typography.md)
- **Full component list & API details**: [.agent/skills/appintoss-tds-mobile/references/components.md](.agent/skills/appintoss-tds-mobile/references/components.md)
- **v1→v2 migration & breaking changes**: [.agent/skills/appintoss-tds-mobile/references/migration-v2.md](.agent/skills/appintoss-tds-mobile/references/migration-v2.md)
