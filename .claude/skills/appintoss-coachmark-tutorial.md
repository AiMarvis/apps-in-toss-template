...
For apps-in-toss or React Native, replace `localStorage` with the platform's async storage (e.g., `SafeStorage`, `AsyncStorage`). See [.agent/skills/appintoss-coachmark-tutorial/references/patterns.md](.agent/skills/appintoss-coachmark-tutorial/references/patterns.md) for the async-safe version with timeout and retry.
...
For detailed UX research and anti-patterns, see [.agent/skills/appintoss-coachmark-tutorial/references/ux-guidelines.md](.agent/skills/appintoss-coachmark-tutorial/references/ux-guidelines.md).
...
- **[.agent/skills/appintoss-coachmark-tutorial/references/patterns.md](.agent/skills/appintoss-coachmark-tutorial/references/patterns.md)**: Advanced patterns including async storage for apps-in-toss, conditional tours, analytics integration, and multi-tour sequencing
- **[.agent/skills/appintoss-coachmark-tutorial/references/ux-guidelines.md](.agent/skills/appintoss-coachmark-tutorial/references/ux-guidelines.md)**: Detailed UX research from NN/g, cognitive load theory, anti-patterns, and A/B testing strategies for coachmarks
